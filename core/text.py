...
class Translator:
    ...
    def translate(
        ...
        command: str,
        string: str,
        ctx: Union[guilded.ext.commands.Context, TranslationContext] = None,
        **values,
    ) -> str:
    ...
    def get_language_preference(
        self, ctx: Union[guilded.ext.commands.Context, TranslationContext]
    ) -> str:
        ...
        * Return the bot default.
        ...
        elif ctx.__class__ == guilded.ext.commands.Context:
